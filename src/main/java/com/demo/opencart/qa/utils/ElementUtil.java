...
public class ElementUtil {
	...
	/*
	 * public WebElement doPresenceOfElementLocated(By locator, int timeOut, long
	 * intervalTime) { WebDriverWait wait = new WebDriverWait(driver,
	 * Duration.ofSeconds(timeOut), Duration.ofMillis(intervalTime)); return
	 * wait.until(ExpectedConditions.presenceOfElementLocated(locator));
	 * 
	 * }
	 * 
	 * public WebElement waitForElementToBeVisible(By locator, int timeOut, long
	 * intervalTime) { WebDriverWait wait = new WebDriverWait(driver,
	 * Duration.ofSeconds(timeOut), Duration.ofMillis(intervalTime)); return
	 * wait.until(ExpectedConditions.visibilityOfElementLocated(locator)); }
	 * 
	 * public WebElement waitForElementToBeVisibleWithWebElement(By locator, int
	 * timeOut, long intervalTime) { WebDriverWait wait = new WebDriverWait(driver,
	 * Duration.ofSeconds(timeOut), Duration.ofMillis(intervalTime)); return
	 ...
	 * 
	 * public List<WebElement> waitForElementsToBeVisible(By locator, int timeOut,
	 * long intervalTime) { WebDriverWait wait = new WebDriverWait(driver,
	 * Duration.ofSeconds(timeOut), Duration.ofMillis(intervalTime)); return
	 * wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(locator)); }
	 * 
	 ...
	 * List<String> eleTextList = new ArrayList<String>(); for (WebElement e :
	 * eleList) { String text = e.getText(); eleTextList.add(text); } return
	 * eleTextList; }
	 * 
	 *//**************** wait util for Non-WebElements *****************//*
																			 * 
																			 * public boolean waitForURLToContain(String
																			 * urlFraction, int timeOut) { WebDriverWait
	...
	/*
	 * public String doGetTitleWithFraction(String titleFraction, int timeOut) { if
	 * (waitForTitleContains(titleFraction, timeOut)) { return driver.getTitle(); }
	 * return null; }
	 * 
	 * public String doGetTitle(String title, int timeOut) { if
	 * (waitForTitleToBe(title, timeOut)) { return driver.getTitle(); } return null;
	 * }
	 */
	/*
	 ...
	 * 
	 * public boolean waitForTitleToBe(String title, int timeOut) { WebDriverWait
	 * wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut)); return
	 * wait.until(ExpectedConditions.titleIs(title)); }
	 * 
	 * public Alert waitForAlert(int timeOut) { WebDriverWait wait = new
	 * WebDriverWait(driver, Duration.ofSeconds(timeOut)); return
	 * wait.until(ExpectedConditions.alertIsPresent()); }
	 * 
	 * 
	 * public String getAlertText(int timeOut) { return
	 * waitForAlert(timeOut).getText(); }
	 * 
	 * public void doAlertAccept(int timeOut) { waitForAlert(timeOut).accept(); }
	 * 
	 * public void doAlertDismiss(int timeOut) { waitForAlert(timeOut).dismiss(); }
	 * 
	 ...
	 * 
	 * public void waitForFrameByIndex(int frameIndex, int timeOut) { WebDriverWait
	 ...
	 * }
	 * 
	 * public void clickElementWhenReady(By locator, int timeOut) { WebDriverWait
	 * wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	 * wait.until(ExpectedConditions.elementToBeClickable(locator)).click(); }
	 * 
	 * public void clickElementWhenReady(By locator, int timeOut, long intervalTime)
	 * { WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut),
	 * Duration.ofMillis(intervalTime));
	 * wait.until(ExpectedConditions.elementToBeClickable(locator)).click(); }
	 * 
	 * public WebElement waitForElementPresntUsingFluentWait(By locator, int
	 ...
	 * .ignoring(StaleElementReferenceException.class).withMessage(Errors.
	 * ELEMENT_NOT_FOUND_ERROR_MESSG);
	 * 
	 * return wait.until(ExpectedConditions.presenceOfElementLocated(locator));
	 * 
	 * }
	 * 
	 * public WebElement waitForElementUsingWebDriverWait(By locator, int timeOut,
	 * int pollingTime) {
	 * 
	 * WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	 * wait.pollingEvery(Duration.ofSeconds(pollingTime)).ignoring(
	 * NoSuchElementException.class)
	 * .ignoring(StaleElementReferenceException.class).withMessage(Errors.
	 * ELEMENT_NOT_FOUND_ERROR_MESSG);
	 * 
